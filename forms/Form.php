...
class Form {
    ...
    public static function form_register($pageID) {
        $form='<form method="post" action="index.php?pageID='.$pageID.'">';
        $form.='<div class="form-group">';
        $form.='<label for="username">Username</label><input required type="text" class="form-control" id="username" name="username" pattern="[a-zA-Z0-9óáéí\']{1,45}" title="Unique username (up to 45 Characters)">';
        ...
        $form.='</div> ';
        $form.='<button type="submit" class="btn btn-default" name="btn-register">Register</button>';
        $form.='</form>';
